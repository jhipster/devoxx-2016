...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "hispterstore@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "hispterstore API";

        private String description = "hispterstore API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "hispterstore";
